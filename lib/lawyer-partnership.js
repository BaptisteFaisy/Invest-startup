...
const LAWYER_PARTNERSHIP_VERSION = 3;
...
// Trois cas, du plus engageant au moins engageant : un plafond publié ; un
// forfait INDICATIF par type de levée (grille tarifaire de la homepage), que la
// convention d'honoraires confirme mission par mission ; aucun tarif publié —
// on l'écrit noir sur blanc plutôt que d'afficher un prix vide : un avocat ne
// peut pas adhérer à une grille fantôme.
