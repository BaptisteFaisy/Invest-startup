...
const TEMPLATE_CATALOG = [
  ...
  { group: 'Closing', items: [
    { slug: 'rapport-du-president-sur-l-augmentation-de-capital-et-la-suppression-du-dps', label: "Rapport du président — augmentation de capital (suppression du DPS)" },
    { slug: 'attestations-de-versement-des-fonds-par-les-investisseurs', label: 'Attestation de versement des fonds (augmentation de capital)' },
  ...
  { group: 'BSA-AIR', items: [
    ...
    { slug: 'attestation-de-versement-des-fonds-par-le-s-souscripteur-s', label: 'Attestation de versement des fonds (BSA-AIR)' },
