...
const LAWYER_PARTNERSHIP_VERSION = 1;
...
const PARTNERSHIP_SECTIONS = [
  ...
  },
  {
    ...
    clauses: [
      'Les échanges couverts par le secret professionnel entre l’Avocat et son client empruntent l’e-Partage du CNB. Liquid+ ne conserve pas ces échanges et n’y a pas accès.',
      'Liquid+ s’interdit d’accéder au contenu des correspondances entre l’Avocat et la société cliente, et de les exploiter à quelque fin que ce soit.',
      'L’Avocat s’interdit de communiquer à Liquid+ toute information couverte par le secret professionnel.',
    ],
  },
  {
    key: 'conflits',
...
// Rend la grille en clauses lisibles. Aucun tarif n'étant publié à ce jour
// (cf. AVOCAT_PRESTATIONS dans server.js), on l'écrit noir sur blanc plutôt que
// d'afficher un prix vide : un avocat ne peut pas adhérer à une grille fantôme.
function grilleLines(prestations) {
  ...
  lines.push('Aucun plafond n’étant arrêté à ce jour, l’Avocat fixe librement ses honoraires avec la société cliente. La grille chiffrée fera l’objet d’une version ultérieure de la présente convention, soumise à son acceptation.');
  return lines;
}
