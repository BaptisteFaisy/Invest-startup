...
const DEFAULT_FIELDS = Object.freeze({
  ...
  // Le contrôle des conflits et le motif d'un refus sont du secret professionnel :
  // ils peuvent révéler qui d'autre le cabinet conseille. Seuls les champs de
  // premier niveau sont chiffrables — d'où des champs plats plutôt qu'imbriqués.
  lawyer_mission_acceptances: Object.freeze({
    conflict_note: 'utf8',
    decline_reason_note: 'utf8',
    fee_agreement_reference: 'utf8',
  }),
});
