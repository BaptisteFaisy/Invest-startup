...
function showFounderWelcomeOffer(user) {
  ...
  style.textContent = `
    ...
    .liquid-welcome__close{position:absolute;top:14px;right:14px;display:grid;place-items:center;width:38px;height:38px;padding:0;border:0;border-radius:50%;background:#f0f1f3;color:#344054;font-size:25px;line-height:1;cursor:pointer}.liquid-welcome__close:hover,.liquid-welcome__close:focus-visible{background:#e4e7ec;outline:2px solid #087f6c;outline-offset:2px}
    .liquid-welcome__eyebrow{margin:0 48px 9px 0;color:#087f6c;font:800 11px Archivo,Arial,sans-serif;letter-spacing:.14em;text-transform:uppercase}.liquid-welcome__box h2{max-width:520px;margin:0;font:800 clamp(26px,5vw,36px)/1.12 Archivo,Arial,sans-serif;letter-spacing:-.035em}.liquid-welcome__lead{margin:15px 0 0;color:#475467;font-size:15px;line-height:1.6}
    .liquid-welcome__offer{margin-top:22px;padding:20px;border:1px solid #ccefe7;border-radius:16px;background:#f1fbf8}.liquid-welcome__offer-top{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.liquid-welcome__offer-label{color:#087f6c;font:800 11px Archivo,Arial,sans-serif;letter-spacing:.08em;text-transform:uppercase}.liquid-welcome__price{margin-top:5px;font:800 27px Archivo,Arial,sans-serif;letter-spacing:-.03em}.liquid-welcome__price s{margin-left:6px;color:#98a2b3;font-size:15px;font-weight:600}.liquid-welcome__code{flex:none;padding:9px 11px;border-radius:9px;background:#001839;color:#fff;font:800 12px Archivo,Arial,sans-serif;letter-spacing:.08em}
  ...
  standardButton.addEventListener('click', async () => {
    ...
    try {
      ...
      standardButton.textContent = 'Payer 700 € HT maintenant';
    }
  });
