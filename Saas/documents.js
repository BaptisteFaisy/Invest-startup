...
(function () {
  ...
  const IMPORT_CATEGORY_DEFS = {
    ...
    'air-preparation': [['societe-capital', 'Société et capital'], ['ip-management', 'PI et management package'], ['termes-economiques', 'Termes économiques et simulation']],
    'air-approche': [['confidentialite', 'Confidentialité'], ['presentation', 'Présentation investisseurs']],
    'air-termes': [['instrument-air', "Contrat d'émission"]],
    'air-emission': [['decisions-sociales', 'Rapports et décision collective']],
    'air-souscription': [['souscription-investisseurs', 'Souscription investisseurs'], ['versement-fonds', 'Versement des fonds'], ['constatation', 'Constatation']],
    'air-postemission': [['registres-capital', 'Registres et capitalisation']],
